...
def collate_idf(arr, tokenize, numericalize, idf_dict, pad="[PAD]", device="cpu"):
...
def get_bert_embedding(
    all_sens, model, tokenizer, idf_dict, batch_size=-1, device="cpu"  # device="cuda:0"
):
...
def plot_example(is_flow, reference, translation, device="cpu"):
